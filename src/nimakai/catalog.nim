...
const BuiltinCatalog*: seq[ModelMeta] = @[
  ...
  ModelMeta(id: "deepseek-ai/deepseek-v3.2", name: "DeepSeek V3.2", tier: tSPlus, sweScore: 73.1, ctxSize: 131072, thinking: false, multimodal: false),
  ...
  ModelMeta(id: "qwen/qwen3-next-80b-a3b-thinking", name: "Qwen3 80B Thinking", tier: tS, sweScore: 68.0, ctxSize: 131072, thinking: true, multimodal: false),
  ModelMeta(id: "qwen/qwen3.5-397b-a17b", name: "Qwen3.5 400B VLM", tier: tS, sweScore: 68.0, ctxSize: 131072, thinking: true, multimodal: true),
  ...
  ModelMeta(id: "qwen/qwen3-next-80b-a3b-instruct", name: "Qwen3 80B Instruct", tier: tS, sweScore: 65.0, ctxSize: 131072, thinking: false, multimodal: false),
  ...
  # B+ tier (30-35%)
  ModelMeta(id: "mistralai/ministral-14b-instruct-2512", name: "Ministral 14B", tier: tBPlus, sweScore: 34.0, ctxSize: 32768, thinking: false, multimodal: false),
  ...
  # C tier (<20%)
  ModelMeta(id: "google/gemma-2-9b-it", name: "Gemma 2 9B", tier: tC, sweScore: 18.0, ctxSize: 8192, thinking: false, multimodal: false),
